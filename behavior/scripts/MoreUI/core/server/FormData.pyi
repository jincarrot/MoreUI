...
class CustomForm(DynamicForm):
    ...
    @staticmethod
    def create(playerId: str, title: str | Observable[str], options: CustomOptions={}) -> CustomForm: 
        """
        创建一个自定义表单。
...
class MoreUI:
    ...
    @staticmethod
    def create(playerId: str, layout: MoreUILayoutDict=...) -> MoreUI: 
        """
        创建MoreUI。
        
        --playerId - 需要接收到此表单的玩家id
